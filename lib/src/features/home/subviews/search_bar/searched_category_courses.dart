...
class SearchedCategorycourse extends StatelessWidget {
  final String searchedValue;
  final String categoryname;

  const SearchedCategorycourse({super.key, required this.searchedValue, required this.categoryname});

  @override
  Widget build(BuildContext context) {
    final Stream<QuerySnapshot> _coursesStream =
        FirebaseFirestore.instance.collection('courses').where('courseCategory', isEqualTo: categoryname).snapshots();
